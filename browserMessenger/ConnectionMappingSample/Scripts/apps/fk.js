...
(function () {
    ...
    $(function () {
        ...
        chatHub.client.received = function (message) {
            if (!viewModel.privateChatUser()) {
                var confirmation = confirm("Kullanıcı size mesaj göndermek istiyor.Onaylıyor musunuz?");
                if (confirmation) {
